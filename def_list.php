...
$sql7="delete from defaulter where 1";
...
$d_name=$row5['c_name'];
$d_sub=$row5['c_sub'];
$d_count=$row5['c_count'];

$sql6="insert into defaulter(d_name,d_sub,d_count) values('$d_name','$d_sub',$d_count)";
...
<input type ="submit" name="send" value="SEND MAIL"> </center>
